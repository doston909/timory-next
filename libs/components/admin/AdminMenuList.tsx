...
const AdminMenuList = () => {
	...
	const menu_set = [
		{
			title: 'Users',
			icon: <PersonIcon sx={{ fontSize: 20, color: '#bdbdbd' }} />,
			on_click: () => subMenuChangeHandler('Users'),
		},
		{
			title: 'Watches',
			icon: <SettingsIcon sx={{ fontSize: 20, color: '#bdbdbd' }} />,
			on_click: () => subMenuChangeHandler('Watches'),
		},
		{
			title: 'Community',
			icon: <ForumIcon sx={{ fontSize: 20, color: '#bdbdbd' }} />,
			on_click: () => subMenuChangeHandler('Community'),
		},
		{
			title: 'Cs',
			icon: <SupportAgentIcon sx={{ fontSize: 20, color: '#bdbdbd' }} />,
